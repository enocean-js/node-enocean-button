...
enocean.on("ready", async (function(){               // when ready
	var button = new Button(enocean,4)       // create a new Button an give it the address 1
	if(process.argv[2] == "on"){
		...
		await (button.A0.click() )	         // if you pass the word "off" via the command line, invoke the click Event on A1
	}
